...
@section('content')
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <a class="breadcrumb-item" href="{{route('viewFeaturedProduct')}}">featured products</a>
            <span class="breadcrumb-item active">Edit featured products</span>
        </nav>
